      ...
      <div class="search_header_div">
        <div class="search_input_div">
          <div class="searchtype">
            ...
            <img src="../../assets/img/search/down@2x.png" alt="" class="seledown" @click="showsearch()">
          </div>
          <input
            type="text"
            maxlength="20"
          ...
          />
          <div class="centerimg">
            <img :src="searchimg" alt="" class="search_img" />
          </div>
        </div>
        <div class="search_sele" v-show="showsearchtyoeList">
            <div v-for="(item,index) in searchTypeList" :key="index" @click="changeSearchType(item)">
                {{item.name}}
            </div>
        </div>
      </div>
